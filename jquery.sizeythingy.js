...
(function ($) {
    $.sizeyThingy = function (options) {
        ...
        jQuery('body').prepend('<div id="sizeythingy" style="position:fixed;'+positionThis+'left:0;width:90%;padding:15px 5%;'+sizeyColour+'font-size:17px;z-index:999;" />');
